    ...
    modal.innerHTML = `<div class="base-painel">
      ...
      ${jaTem.length ? `<div class="bp-atuais">
        ...
        ${jaTem.map((b) => `<div class="bp-atual">
          ...
          <span class="bpa-txt"><b>${esc(b.nome)}</b><small>${TIPOS_BASE[b.tipo]?.nome} · ativa há ${(jogo.turno || 0) - (b.desde || 0)} turno(s) · custa ${dinheiro(TIPOS_BASE[b.tipo]?.manutencao || 0)}/turno</small></span>
